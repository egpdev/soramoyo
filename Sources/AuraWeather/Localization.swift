...
enum AuraLanguage: String, CaseIterable, Identifiable {
    ...
    func t(_ key: String) -> String {
        let text: [String: (String, String, String)] = [
            ...
            "whatWear": ("WAS ANZIEHEN", "ЧТО НАДЕТЬ", "WHAT TO WEAR"), "aiNote": ("AURA KI-TIPP", "СОВЕТ AURA AI", "AURA AI NOTE"), "askGemini": ("Gemini fragen", "Спросить Gemini", "Ask Gemini"), "enableGemini": ("Gemini aktivieren", "Включить Gemini", "Enable Gemini"),
